...
const BookSingle = ({book}) => {
  ...
  return (
    <div key={book._id} className="border-2 border-gray-500 rounded-lg px-4 py-2 m-4 relative hoever:shadow-xl">
    ...
    <div className="flex justify-between items-center gap-x-2 mx-4 p-4">
